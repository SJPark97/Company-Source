...
import { openModal } from "@/stores/comparison/controlModal";
...
export default function CompanyComparisonCard({ cardLocation }: Iprops) {
  ...
  const leftCardCompanyInfo = useSelector((state: RootState) => {
    return state.leftSelectedCompany
  })
  const rightCardCompanyInfo = useSelector((state: RootState) => {
