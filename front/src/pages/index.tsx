...
export default function Home() {
  ...
  const secondTitle = '당신이 원하는 분석 기법으로\n 다양한 기업들을 비교해보세요.'
    ...
    <div className='flex flex-col w-full'>
      ...
      <div className='flex bg-cover bg-gradient-to-b from-[#ffffff] to-[#F9FAFB] h-screen items-center'>
        ...
        <div className='h-full'>
          <LandingImageCard src="" className='relative left-0 top-[20vh] w-[30vw] h-[40vh]' />
          <LandingImageCard src="" className='relative left-[5vw] -top-[10vh] w-[30vw] h-[40vh]' />
          <LandingImageCard src="" className='relative left-[10vw] -top-[40vh] w-[30vw] h-[40vh]' />
        </div>
      </div>

      <div className='flex items-center h-screen bg-white bg-cover'>
        <div className='flex flex-col justify-center h-full'>
          <LandingImageCard src="" className='w-[30vw] h-[60vh]' />
        </div>
      ...
      <div className='flex bg-cover bg-gradient-to-b from-[#F9FAFB] to-[#FFFFFF] h-screen items-center'>
        ...
        <LandingImageCard src="/landing-community.png" className=' w-[40vw] h-[59vh]' />
      </div>
