...
import { cancelLikeDetailAxios, createComment, getCorpBoardDetail, likeDetailAxios } from "@/utils/commnuity/api";
...
export default function corpBoardDetail({ data, accessToken }: { data: any, accessToken: string }) {
